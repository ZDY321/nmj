...
function scheduleAssistantSystemPrompt(): string {
  return [
    ...
    "支持的动作类型：create_student、create_course、update_course、delete_course、migrate_course、schedule_lessons、sync_lessons、ask_clarification。",
    "update_course 用于修改已有课程名称、科目、班型、校区、关联学生或启用/暂停状态；data 里应包含 courseId 或 courseName。",
